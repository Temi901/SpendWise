...
SECRET_KEY = 'django-insecure-k1@d&%n0@(m+am_uqzc(*8xr=mij&+lz-5e*qzqpg07yqszrk%'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('jejetemmy8@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('uvnp uvol ygqe jxla')
